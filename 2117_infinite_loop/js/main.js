...
document.querySelector('.tm-navbar').classList.toggle('dark-mode');
document.querySelectorAll('.blockquote-text').forEach(blockqquote => blockqquote.classList.toggle('dark-mode'));
document.querySelectorAll('.bubbletail').forEach(bubbletail => bubbletail.classList.toggle('dark-mode'));
document.querySelector('.navbar-collapse').classList.toggle('dark-mode');
document.querySelectorAll('.tm-nav-link').forEach(link => link.classList.toggle('dark-mode'));
document.querySelectorAll('.tm-btn-primary').forEach(button => button.classList.toggle('dark-mode'));
});
